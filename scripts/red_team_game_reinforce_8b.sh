...
REMOTE_RM_URL="${REMOTE_RM_URL:-http://${HOST_IP}:5000/classify}"

WANDB_API_KEY="${WANDB_API_KEY:?Set WANDB_API_KEY before running}"

WANDB_CONFIG="--wandb_org donoclay-university-of-washington \
--wandb_run_name $RUN_NAME \
--use_wandb $WANDB_API_KEY \
--wandb_project self-redteaming-replication \
--wandb_max_log 10000 \
...
# Run the training script directly (~44 steps/episode at rollout_batch_size=896;
# 5 episodes gives ~220 steps, capped at 200 by --stop_at_step_200)
